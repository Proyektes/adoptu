...
(2,'Mia',      'DOG','Beagle',                'Mia es curiosa, alegre y le encanta jugar.',      10.2,2,8,'FEMALE','AVAILABLE',  'Tricolor', 'SMALL', 'Alegre',    true, true,  'Antirrábica, Moquillo, Parvovirus',   true,  true,  true,  true,  'HIGH',   1730592000000,'Benito Juárez, CDMX',      650.00,'MXN',false,false,1730592000000),
...
(5,'Mona',     'DOG','Labrador Retriever',    'Mona es gentil con todos los animales.',          27.0,1,6,'FEMALE','AVAILABLE',  'Negro',   'LARGE',  'Gentil',    true, false, 'Antirrábica, Moquillo',               true,  true,  true,  true,  'MEDIUM', 1719964800000,'Escobedo, Nuevo León',    800.00,'MXN',false,false,1719964800000),
...
(7,'Laika',    'DOG','Mestizo',               'Laika es curiosa como la famosa cosmonauta.',     8.0, 1,0,'FEMALE','AVAILABLE',  'Café',     'SMALL', 'Curiosa',   false,false, 'Antirrábica',                         true,  true,  true,  false, 'HIGH',   1730592000000,'Itagüí, Antioquia',       0.00,'COP', false,false,1730592000000),
...
(9,'Frida',    'DOG','Labrador Retriever',    'Frida es una labrador negra muy elegante.',       28.5,2,0,'FEMALE','AVAILABLE',  'Negro',    'LARGE', 'Elegante',  true, true,  'Antirrábica, Moquillo, Parvovirus',   true,  true,  true,  true,  'MEDIUM', 1735862400000,'Envigado, Antioquia',     0.00,'COP', false,false,1735862400000),
...
(11,'Nena',    'DOG','Golden Retriever',      'Nena es la primera en recibirte al llegar.',      28.0,4,0,'FEMALE','AVAILABLE',  'Dorado',   'LARGE', 'Amorosa',   true, true,  'Antirrábica, Moquillo, Parvovirus',   true,  true,  true,  true,  'MEDIUM', 1738540800000,'Santa Catarina, NL',      900.00,'MXN',false,false,1738540800000),
...
(15,'Penny',   'DOG','Labrador Retriever',    'Penny vale su peso en oro y en amor.',            29.0,1,0,'FEMALE','AVAILABLE',  'Chocolate','LARGE','Valiosa',    false,false, 'Antirrábica',                         true,  true,  true,  false, 'HIGH',   1750550400000,'La Florida, Santiago',    0.00,'CLP', false,false,1750550400000),
