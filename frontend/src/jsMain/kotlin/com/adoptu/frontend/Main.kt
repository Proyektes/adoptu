        ...
        CommonModule.initI18n(null).then<Unit> {
            try {
                when {
                    ...
                    path == "/admin-shelters" || path == "/admin-shelters/" || path == "/admin/shelters" || path == "/admin/shelters/" -> AdminSheltersPageModule.init()
                    ...
                    path == "/admin-sterilization-locations" || path == "/admin-sterilization-locations/" || path == "/admin/sterilization-locations" || path == "/admin/sterilization-locations/" -> AdminSterilizationLocationsPageModule.init()
